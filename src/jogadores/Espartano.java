...
public final class Espartano extends Guerreiro {
	...
	public Espartano(final Espartano outro) {
		super(outro.nomedoPersonagem, outro.datadeNascimento.getDay(), outro.datadeNascimento.getMonth(),
				outro.datadeNascimento.getYear(), outro.life, outro.agility, outro.armor, outro.strenght,
				outro.recompensas, outro.espadadoGuerreiro);
